 ...
 */
public class Iono implements Streamable {
	...
	public Iono(DataInputStream dai, boolean oldVersion) throws IOException{
		read(dai,oldVersion);
	}
	public Iono(Ephemeris.IonosphericModelProto ionoProto){
