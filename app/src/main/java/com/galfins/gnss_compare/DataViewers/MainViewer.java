    ...
    private class PoseItem implements CalculationGridItem {
        ...
        public void update(CalculationModule calculationModule) {
            ...
            if (nameView != null &&
                ...
                latView.setText(String.format("%.6f", calculationModule.getPose().getGeodeticLatitude()));
                lonView.setText(String.format("%.6f", calculationModule.getPose().getGeodeticLongitude()));
